...
def predict_test_df(df_train, df_val, evaluator):
    ...
    for rank, lmbda, numIter in itertools.product(ranks, lambdas, numIters):
        als = ALS(rank=rank, maxIter=numIter, regParam=lmbda, numUserBlocks=10, numItemBlocks=10, implicitPrefs=False,
                  alpha=1.0,
                  userCol="user_id", itemCol="game_id", seed=1, ratingCol="rating", nonnegative=False,
...
def un_pickle_labeled_df():
    with open('data/pickles/nmf_labeled_df_p2.pkl', 'rb') as fp:
...
if __name__ == '__main__':
    ...
    # optimized_model.save("/Users/micahshanks/Galvanize/capstone/data/als_model_new")
